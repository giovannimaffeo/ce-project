...
def check_combinations_normality(algorithm, test_type):
  reference_run_dir = f"outputs/evolve_structure/{algorithm.__name__}/{test_type}/reference_run"
...
def check_non_parametric_combinations_difference(algorithm, test_type):
  reference_run_dir = f"outputs/evolve_structure/{algorithm.__name__}/{test_type}/reference_run"
  log_file = os.path.join(reference_run_dir, "statistical_test_result.txt")
...
def check_pairwise_non_parametric_comparisons(algorithm, test_type):
  reference_run_dir = f"outputs/evolve_structure/{algorithm.__name__}/{test_type}/reference_run"
  log_file = os.path.join(reference_run_dir, "statistical_test_result.txt")
...
def stats_ea_search_hiperparams_fatorial_test():
  ...
  if not is_parametric:
    check_non_parametric_combinations_difference(algorithm, test_type)
